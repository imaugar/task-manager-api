...
import com.imaugar.task_manager_api.dtos.TaskStatusDTO;
...
public class TaskController {
    ...
    public ResponseEntity<TaskResponseDTO> createTask(@Valid @RequestBody TaskDTO task) {
    ...
    public ResponseEntity<TaskResponseDTO> updateTaskStatus(@PathVariable Long taskId, @Valid @RequestBody TaskStatusDTO updatedStatus) {
        return ResponseEntity.ok(taskService.updateTaskStatus(taskId, updatedStatus.getStatus()));
    }
